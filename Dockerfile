...
LABEL maintainer="https://github.com/davidfischer"
...
CMD ["gunicorn", "--timeout", "60", "--bind", ":8000", "--workers", "2", "--max-requests", "10000", "--max-requests-jitter", "100", "--log-file", "-", "--access-logfile", "-", "config.wsgi"]
